...
const typeofTests = [
  ...
  {
    name: "str, anything with quotes!",
    args: ["anything with quotes!"],
    expected: "string"
  },
  ...
  { name: "120.00", args: [128.0], expected: "number" },
  { name: "infinity", args: [Infinity], expected: "number" },
  { name: "34", args: [34], expected: "number" },
  { name: "0", args: [0], expected: "number" },
  { name: "125/5", args: [125 / 5], expected: "number" }
];
...
const typeofReturnsAStringTests = [
  ...
  {
    name: "str, anything with quotes!",
    args: ["anything with quotes!"], expected: "string" },
  { name: "num, 4", args: [4], expected: "number" }
];
