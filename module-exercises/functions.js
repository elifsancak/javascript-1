...
const writeTestCases1 = [
  { name: 'first', args: [2, 3], expected: 5 },
  { name: 'second', args: [4, 1], expected: 5 },
  ...
  { name: 'fifth', args: [1, 7], expected: 8 }, // create your own test case!
  { name: 'sixth', args: [6, 3], expected: 9 }, // create your own test case!
];
...
const writeTestCases2 = [
  { name: 'first', args: [8, 3], expected: 5 },
  { name: 'second', args: [14, 9], expected: 5 },
  ...
  { name: 'fifth', args: [5, 2], expected: 3 }, // create your own test case!
  { name: 'sixth', args: [11, 1], expected: 10 }, // create your own test case!
];
...
const writeTestCases3 = [
  ...
  { name: 'fifth', args: [3, 7], expected: 21 }, // create your own test case!
  { name: 'sixth', args: [6, 3], expected: 18 }, // create your own test case!
];
...
const writeTestCases4 = [
  ...
  { name: 'sixth', args: ['x', 'y', 'z'], expected: 'zxy' }, // create your own test case!
];
...
const writeTestCases5 = [
  ...
  { name: 'fifth', args: ['y', 'x', 'z'], expected: 'xzy' }, // create your own test case!
